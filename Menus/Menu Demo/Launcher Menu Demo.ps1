...
#Array
Show-STMenu -Title "Array Menu" -Choices @("Test1", "Test2", "Test3", "Test4", "Test5", "Test6", "Test7") -Back -Exit -Custom "Extra Option" -ItemsDisplayed 2 -Info @("Command", 'Show-STMenu -Title "Array Menu" -Choices @("Test1", "Test2", "Test3", "Test4", "Test5", "Test6", "Test7") -Back -Exit -Custom "Extra Choice"')
